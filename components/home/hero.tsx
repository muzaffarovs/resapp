...
const Hero = () => {
  return (
    <section className="h-screen md:h-full w-full md:w-[calc(100%-4rem)] brightness-90 max-w-7xl bg-[url('/hero1.jpg')] bg-cover bg-center md:border border-gray-700 md:rounded-xl z-20 mx-auto relative">
      <div className="absolute inset-0 bg-black bg-opacity-40 md:rounded-xl"></div>

      <div className="relative pb-28 md:pb-10 pt-36 md:pt-28 rounded-xl">
        <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="font-mono mt-4 text-lg text-gray-100 drop-shadow-md">
